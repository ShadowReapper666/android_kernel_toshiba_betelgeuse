...
static struct clk_pll_freq_table tegra_pll_x_freq_table[] = {
	/* 1.6 GHz */
        { 12000000, 1400000000, 800,  6,  1, 12},
        { 13000000, 1400000000, 985,  8,  1, 12},
        { 19200000, 1400000000, 1000, 12,  1,  8},
        { 26000000, 1400000000, 800, 13,  1, 12},

	/* 1.4 GHz */
        { 12000000, 1400000000, 704,  6,  1, 12},
        { 13000000, 1400000000, 864,  8,  1, 12},
        { 19200000, 1400000000, 940, 12,  1,  8},
        { 26000000, 1400000000, 752, 13,  1, 12},	
...
static struct tegra_sku_rate_limit sku_limits[] =
{
	...
	RATE_LIMIT("cpu",	1600000000, 0x14, 0x17, 0x18, 0x1B, 0x1C),
	RATE_LIMIT("cclk",	1600000000, 0x14, 0x17, 0x18, 0x1B, 0x1C),
	RATE_LIMIT("pll_x",	1600000000, 0x14, 0x17, 0x18, 0x1B, 0x1C),
